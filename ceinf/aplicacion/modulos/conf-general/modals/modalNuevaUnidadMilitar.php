        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Nueva Unidad Militar</h5>
                </div>
                <div class="modal-body">
                    <div class="row mb-4">
                        <div class="col-lg-8 mb-4">
                            <input type="text" name="nombreUnidadMilitar" id="nombreUnidadMilitar" class="form-control has-feedback-left" placeholder="Unidad Militar" required>
    ...
    $(document).ready(function() {
        $("#frmModal").validate({
            submitHandler: function(form) {
                $.post(
                    "logica/insert?case=nueva-unidad-militar", 
                    $.param($("#frmModal").serializeArray()), 
                    function(data) {
                        if(data == "completado") {
                            alertify.alert("Unidad Militar creada con éxito. Recuerde agregar sus dependencias.", function(){
