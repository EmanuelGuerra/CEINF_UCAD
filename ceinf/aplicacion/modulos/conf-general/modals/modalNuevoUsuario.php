        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6 mb-4">
                            <input type="text" name="carnet" id="carnet" class="form-control has-feedback-left" placeholder="Carnet" required>
    ...
    $(document).ready(function() {
        $("#frmModal").validate({
            submitHandler: function(form) {
                $.post(
                    "logica/insert?case=nuevo-usuario", 
                    $.param($("#frmModal").serializeArray()), 
                    function(data) {
                        if(data == "completado") {
                            alertify.alert("Credenciales creadas con éxito. El empleado ya puede iniciar sesión.", function(){
